...
class BookingController extends Controller
{
    ...
    public function paymentStore(StorePaymentRequest $request){
        ...
        try {
            ...
            return redirect()->back()->withErrors(['error' => 'Payment storage failed, please try again' . $e->getMessage()]);
    ...
    public function checkBookingDetails(StoreCheckBookingRequest $request){
        ...
        return redirect()->route('front.check_booking')->withErrors(['error' => 'Transaction not found, please try again']);
    }
}
