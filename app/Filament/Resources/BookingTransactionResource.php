            ...
            ->schema([
                Wizard::make([
                    Step::make('Product and Price')->schema([
                        Select::make('workshop_id')->relationship('workshop', 'name')->searchable()->preload()->required()->live()->afterStateUpdated(function ($state, callable $set){
                        ...
                        TextInput::make('quantity')->required()->numeric()->prefix("Audience Qty")->live()
                        ...
                        TextInput::make('total_amount')->required()->numeric()->prefix('IDR')->readOnly()->helperText('PPN 11% Included'),

                        Repeater::make('participants')->schema([
                            Grid::make(2)->schema([
                        ...
                        ])->columns(1)->label('Participants Details'),
                    ]),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                IconColumn::make('is_paid')->boolean()->trueColor('success')->falseColor('danger')->trueIcon('heroicon-o-check-circle')->falseIcon('heroicon-o-x-circle')->label('Verified'),
            ])
            ->filters([
